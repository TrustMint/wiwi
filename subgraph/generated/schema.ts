...
export class User extends Entity {
  ...
  get firstDealTimestamp(): BigInt | null {
    let value = this.get("firstDealTimestamp");
    if (!value || value.kind == ValueKind.NULL) {
      return null;
    } else {
      return value.toBigInt();
  ...
  set firstDealTimestamp(value: BigInt | null) {
    if (!value) {
      this.unset("firstDealTimestamp");
    } else {
      this.set("firstDealTimestamp", Value.fromBigInt(<BigInt>value));
    }
  }
...
export class Review extends Entity {
  ...
  set commentCid(value: string | null) {
    if (!value) {
      this.unset("commentCid");
    } else {
      this.set("commentCid", Value.fromString(<string>value));
    }
  }
