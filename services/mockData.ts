...
// FIX: Added missing dmtBalance and stake properties to align with the User type.
    dmtBalance: 100000,
    stake: 50000,
    lockedStake: 1200,
...
const mockVotes: Vote[] = [
    { voterUsername: 'satoshi.eth', voterAvatar: `https://i.pravatar.cc/150?u=user-1`, choice: 'for', power: 50000, timestamp: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000).toISOString() },
    { voterUsername: 'elon.eth', voterAvatar: `https://i.pravatar.cc/150?u=user-3`, choice: 'against', power: 25000, timestamp: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000).toISOString() },
    { voterUsername: 'user.gm', voterAvatar: `https://i.pravatar.cc/150?u=user-4`, choice: 'for', power: 75000, timestamp: new Date(Date.now() - 1 * 12 * 60 * 60 * 1000).toISOString() },
];
...
export const mockArbitrationCases: ArbitrationCase[] = [
    {
        ...
        votesForBuyer: 2,
        votesForSeller: 1,
        arbitrators: ['satoshi.eth', 'vitalik.eth', 'elon.eth', 'arbiter4.eth', 'arbiter5.eth'],
        votes: [
            { arbitratorAddress: 'satoshi.eth', decision: 'buyer', comment: 'Продавец не предоставил достаточно убедительных доказательств отправки.', timestamp: new Date().toISOString() },
            { arbitratorAddress: 'vitalik.eth', decision: 'buyer', comment: 'Отсутствие ответа от продавца вызывает подозрения.', timestamp: new Date().toISOString() },
            { arbitratorAddress: 'elon.eth', decision: 'seller', comment: 'Квитанция выглядит подлинной.', timestamp: new Date().toISOString() }
        ],
