                ...
                {listing.status === 'Archived' ? (
                    <div className="flex justify-end items-center pt-2.5 border-t border-white/10">
                        <button
                            ...
                            className="flex items-center gap-1.5 text-sm font-medium text-gray-300 hover:text-green-400 active:text-green-300 transition-colors"
                        >
                ...
                {activeTab === 'assets' && (
                    <GlassPanel className="overflow-hidden">
                        {isBalanceLoading ? (
                            ...
                            <div className="divide-y divide-white/10">
                                <AssetRow icon={<ETHIcon className="w-8 h-8" />} symbol="ETH" balance={nativeBalance} pricePerToken={3500} />
                                <AssetRow icon={<USDCIcon className="w-8 h-8" />} symbol="USDC" balance={tokenBalances.USDC} pricePerToken={1} />
                                <AssetRow icon={<USDTIcon className="w-8 h-8" />} symbol="USDT" balance={tokenBalances.USDT} pricePerToken={1} />
                                <AssetRow icon={<DMTIcon className="w-8 h-8" />} symbol="DMT" balance={tokenBalances.DMT} pricePerToken={0.85} />
                            </div>
                        )}
                    </GlassPanel>
                )}
