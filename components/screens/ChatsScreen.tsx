...
import { SearchIcon, PinIcon, CheckIcon, DoubleCheckIcon, ScaleIcon, BitcoinIcon } from '../icons/Icons';
import { GlassPanel } from '../shared/GlassPanel';
import { useTapOrSwipe } from '../../hooks/useTapOrSwipe';
...
const ChatRow: React.FC<{ chat: Chat; onClick: () => void; }> = ({ chat, onClick }) => {
    ...
    const onTouchEnd = getTouchEndHandler(onClick);
    ...
    return (
        ...
        >
            <div className="relative w-14 h-14 rounded-full bg-gray-800 flex items-center justify-center flex-shrink-0">
            ...
            <div className="relative">
                <img 
                    ...
                    onError={(e) => {
                        ...
                        target.src = 'data:image/svg+xml;base64,';
                    }}
                />
...
const SegmentedControl: React.FC<SegmentedControlProps> = ({ activeFilter, onFilterChange }) => (
    <div className="p-1 bg-black/20 rounded-2xl grid grid-cols-3 gap-1">
        <button 
            onClick={() => onFilterChange('all')}
            className={`w-full py-1.5 rounded-xl text-sm font-semibold transition-all duration-300 ${
                activeFilter === 'all' 
...
export const ChatsScreen: React.FC<ChatsScreenProps> = ({ 
    ...
    return (
        <div className="flex flex-col bg-black h-full">
            ...
            <div className="sticky top-0 z-10 p-4 bg-black/80 backdrop-blur-lg space-y-4">
                <div className="flex items-center gap-3 transition-all duration-300">
                    <div className="relative flex-grow">
                        ...
                        <input
                            ...
                            className="w-full bg-gray-900 border border-gray-800 rounded-2xl pl-10 pr-4 py-2 text-base text-white placeholder-gray-500 focus:border-cyan-500 focus:outline-none transition-all"
