...
const TabBarItemRenderer: React.FC<TabBarItemRendererProps> = ({
  ...
  if (isAction) {
    return (
      ...
      >
        <div className={`
          flex items-center justify-center w-12 h-10 rounded-2xl text-white shadow-lg transform transition-all duration-200
          ${disabled 
  ...
  return (
    <button 
      ...
      aria-disabled={disabled}
    >
      {/* The animated pill background for active state - UPDATED: Light matte gray glass */}
      <span 
        className={`
